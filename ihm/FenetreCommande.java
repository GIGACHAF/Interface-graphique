...
public class FenetreCommande extends JFrame {
    ...
    private java.util.List<Tomate> tomatesAffichées = new ArrayList<>();
    ...
    private void initUI() {
        ...
        tablePanier.getColumnModel().getColumn(3).setCellEditor(new QuantiteCellEditor(this, panier, tomatesAffichées));
    ...
    private void mettreAJourAffichage() {
        ...
        float expédition = 5.50f;
        float total = sousTotal + expédition;

        labelSousTotal.setText(String.format("%.2f €", sousTotal));
        labelExpedition.setText(String.format("%.2f €", expédition));
    ...
    private static class QuantiteCellEditor extends AbstractCellEditor implements TableCellEditor {
        ...
        public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
            ...
            if (tomateTrouvée == null) return new JLabel("Erreur");
            ...
            comboBox.addActionListener(e -> {
                ...
                // Supprime et réinsère pour éviter les doublons
